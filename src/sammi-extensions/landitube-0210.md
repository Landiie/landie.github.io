...
- Hotkeys, or no hotkeys! You can set up custom SAMMI triggers/commands to change an emotion directly! 🔧
- Built using OBS Sources, so your PNGs will look crisp and have no artifacts! 📸
